$(document).ready(function () {
          ...
          estudiantes.data.slice(inicio, fin).forEach((estudiante) => {
            ...
            resultado += `
                        ...
                        <td class="px-6 py-4 font-sans flex flex-row">
                            <a class="px-2" id="info" data_id="${estudiante.id_estudiante}">
                                <i class="fa-solid fa-clipboard" trigger="hover" data-tooltip-target="informacion"
                                    style="color:#fbb61d;font-size:2.3rem;"></i>
                            ...
                            <a class="px-2" href='modiEstu.php?id=${estudiante.id_estudiante}'>
                                <i class='fa-solid fa-pen-to-square' trigger="hover" data-tooltip-target="modificar"
                            ...
                            <a class="px-2" id="delete" data_id="${estudiante.id_estudiante}">
                                <i class='fa-solid fa-trash' trigger="hover" data-tooltip-target="eliminar"
                                    style="color:#e83a30;font-size:2.3rem;"></i>
        ...
        if (alumno.status == false) {
          ...
          alumno.data.forEach((alum) => {
            ...
            resultado += `
                        ...
                        <div class="relative p-4 w-full max-w-2xl h-full md:h-auto flex items-center justify-center">
                                ...
                                <div class="p-6 space-y-6">
                                    ...
                                    <div class="relative z-0 w-full mb-3 group">
                                        <input type="text" id="disabled_input" aria-label="disabled input"
                                            class="my-4 font-sans mb-1 bg-gray-100 border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 cursor-not-allowed dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            value="${alum.id_estudiante}" disabled>
                                        <label for="floating_first_name"
                                            class="font-sans peer-focus:font-medium absolute text-base text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Código</label>
                                    </div>
                                    <div class="relative z-0 w-full mb-3 group">
                                        ...
                                        <div class="grid grid-cols-2 gap-6 pt-1">
                                            <div class="relative z-0 w-full mb-6 group">
                                                <input type="text" id="disabled-input" aria-label="disabled input"
                                                    class=" font-sans mt-4 bg-gray-100 border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 cursor-not-allowed dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500"
  ...
  //ACCION PARA BORRAR EL ESTDIANTE
