                ...
                if (personal.status == false) {
                    ...
                    personal.data.forEach(usuario => {
                        ...
                        <tr class="bg-white dark:bg-gray-800">
                            ...
                            <td class="py-4 px-6">
                                <a  href="editar_personal.php?id=${usuario.Id_personal}" style="font-size: 20px" class="editar font-medium text-green-600 underline dark:text-green-500 hover:no-underline cursor-pointer" type="button" data-modal-toggle="question"><i class='bx bx-edit'></i></a>
